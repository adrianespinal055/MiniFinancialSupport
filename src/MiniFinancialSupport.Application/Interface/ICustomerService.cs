...
public interface ICustomerService
{
    ...
    Task<CustomerResponse?> UpdateAsync(int id, CreateCustomerRequest request, CancellationToken cancellationToken = default);
    Task<bool> InactivateAsync(int id, CancellationToken cancellationToken = default);
